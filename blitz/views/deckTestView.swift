...
//
//
//    init(width: CGFloat = 450, editBtn: Binding<Bool>, presented: Binding<Bool>, currDeck: Binding<deck>) {
//        self.width = width
//        self.height = self.width * (3/5)
//        self._editBtn = editBtn
//        self._presented = presented
//        self._currDeck = currDeck
//        self.deckTitle = self.currDeck.title
//        self.deckCards = self.currDeck.cards
...
//        deckTestView(editBtn: .constant(false), presented: .constant(false), currDeck: .constant(deck.example))
//    }
//}
//
//
